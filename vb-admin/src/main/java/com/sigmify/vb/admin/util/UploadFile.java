...
public class UploadFile {
	...
	private static final String UPLOAD_DIRECTORY = "profile_upload_files";
	...
	public static String getPathToStoreDocument(String module){	
		String rootpath= System.getProperty("user.dir") + File.separator +  "document-admin" + File.separator+ UPLOAD_DIRECTORY;
		//String rootpath=AdminConstant.FILE_PATH_ADMIN+ File.separator +"document-admin"+ File.separator +UPLOAD_DIRECTORY;
