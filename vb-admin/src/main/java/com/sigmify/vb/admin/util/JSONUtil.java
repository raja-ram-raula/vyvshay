...
public class JSONUtil {
	 ...
	 */
	public   String serialize(Object sourceObject) throws AdminException {
		String result;
		try {
			...
			throw new AdminException(ErrorCode.SERIALIZATION_ERROR, "Serialization error");
		}
		return result;
	}
	 ...
	 */
	public <T> T deserialize(byte[] bytes, Class<T> targetClass) throws AdminException {
		T result;
		try {
			...
			throw new AdminException(ErrorCode.DESERIALIZATION_ERROR,"Deserialization error");
		}
		return result;
	}
	...
	public <T> T deserialize(String jsonString, Class<T> targetClass)
		...
		if (jsonString == null) {
			throw new AdminException(ErrorCode.DESERIALIZATION_ERROR,
	...
	public <T> T deserialize(File jsonFilePath, Class<T> targetClass)
		...
		try {
			...
			throw new AdminException(ErrorCode.FILE_SYSTEM_ERROR,
	 ...
	 * @throws AdminException if any
	 */
	public Map<String, Boolean> deserializeInValidFields(String inValidFieldsJson) throws AdminException {
		
		if (inValidFieldsJson == null) {
			throw new AdminException(ErrorCode.DESERIALIZATION_ERROR,"Trying to deserialize a null string");
		}
